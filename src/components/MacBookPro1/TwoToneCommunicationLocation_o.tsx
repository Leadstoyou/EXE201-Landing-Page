...
const TwoToneCommunicationLocation_o = (props: SVGProps<SVGSVGElement>) => (
...
const Memo = memo(TwoToneCommunicationLocation_o);
export { Memo as TwoToneCommunicationLocation_o };
